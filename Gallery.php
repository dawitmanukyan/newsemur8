...
<html lang="en">
  <head>
    ...
    <title>Կայքում Առկա նկարները</title>
          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <?php echo '<a class="nav-main-link active" href="Gallery.php?h='.$_GET['h'].'">' ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-boxed">
          <div class="row">
            <!-- Story -->
            <?php
              $imgs = $mysql -> query("SELECT * FROM `gallery`");

              foreach($imgs as $value){
                echo '<div class="col-lg-4" style="text-align: center;">
                  <div class="block block-rounded block-link-pop overflow-hidden" href="img/'.$value['img'].'">
                    <a href="img/'.$value['img'].'"><img class="img-fluid" src="img/'.$value['img'].'" alt=""></a>
                    <a href="Delete.php?h='.$_GET['h'].'&id='.$value['id'].'&type=gallery&file=Gallery.php"><button class="btn btn-danger" style="margin: 7px;">Ջնջել</button></a>
                  </div>
                </div>';
              }
            ?>
