            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <?php echo '<a class="nav-main-link active" href="editinfo.php?h='.$_GET['h'].'">' ?>
          ...
          <div class="row">
            ...
            <?php
              ...
              foreach($imgs as $value){
                echo '
                <form action="editinfo-proccess.php?h='.$_GET['h'].'&id='.$value['id'].'" method="post" style="padding: 15px;">
                <div class="mb-4">
                    <label class="form-label" for="example-textarea-input">Խմբագրել հայերեն տեղեկությունը</label>
                    <textarea class="form-control" id="example-textarea-input" name="infoarm" rows="5" placeholder="Մեր մասին․․․">'.$value['infoarm'].'</textarea>
                </div><br>

                <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Խմբագրել ռուսերեն տեղեկությունը</label>
                <textarea class="form-control" id="example-textarea-input" name="inforu" rows="5" placeholder="Մեր մասին․․․">'.$value['inforu'].'</textarea>
            </div><br>

            <div class="mb-4">
            <label class="form-label" for="example-textarea-input">Խմբագրել անգլերեն տեղեկությունը</label>
            <textarea class="form-control" id="example-textarea-input" name="infoeng" rows="5" placeholder="Մեր մասին․․․">'.$value['infoeng'].'</textarea><br>
            
            <button class="btn btn-success" type="submit">Փոփոխել</button>
