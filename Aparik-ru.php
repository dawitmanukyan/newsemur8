...
<body>
  <div class="header" id="header">
    ...
    >
     ...
     <li><a href="About.php">О нас</a><img src="./img/arrow-right-menu.png" class="arrow-right-menu"></li>
      ...
      <li><a href="Blog.php" class="active">Блог</a><img src="./img/arrow-right-menu.png" class="arrow-right-menu"></li>
  ...
  <div class="second-menu">
    ...
    <?php 
              foreach ($asr as $value) {
                echo '<a href="Product.php?type='.$value['category_id'].'" class="sub-menu-a">'.$value['type-ru'].'</a>';
              }
            ?>
    </div>
    <div class="language">
  ...
  <div class="menu_holder">
    ...
    <div class="container">
        ...
        <p class="credit1">Кредит</p>
        <p class="credit_big">Условия кредита</p>
        <p class="transparent_text">
        Ниже вы можете ознакомиться с условиями продажи в кредит.
        </p>
        <p class="long_text">
        Оформление кредита осуществляется в сети магазинов " Семур энд Ко,
          паспорт и соц. после того, как банк запросил
          может также потребовать предоплату и поручителя в случаях.<br /><br />
  
          "АРМЭКОНОМБАНК" - ежемесячная плата за обслуживание 0,55% и годовая плата 9 %
          процентная ставка,<br />
          "АКБА банк» - 0.5% ежемесячная плата за обслуживание и 11 год %
          процентная ставка,<br />
  
          "Америабанк" - номинальная процентная ставка 0-21.5% без комиссии за обслуживание.
        </p>
        <div class="text_center1">СОТРУДНИЧАЕМ</div>
        <hr />
