  ...
  <head>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <ul class="nav-main">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <?php echo '<a class="nav-main-link" href="Add-categories.php?h='.$_GET['h'].'">' ?>
                      <span class="nav-main-link-name">Ավելացնել կածեգորյա</span>
                    </a>
                  </li>
                  <li class="nav-main-item">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <?php echo' <a class="nav-main-link active" href="Add-image.php?h='.$_GET['h'].'"> '; ?>
      ...
      <main id="main-container">
        ...
        <div class="bg-primary-dark">
          <div class="content content-full text-center pt-7 pb-6">
            ...
            <h2 class="h2 text-white mb-2">
              <?php echo '<a href="Gallery.php?h='.$_GET['h'].'">Կայքում առկա նկարները</a>' ?>
            </h2>
        ...
        <div class="mb-4">
            <?php echo' <form action="Add-image-proccess.php?h='.$_GET['h'].'" method="POST" enctype="multipart/form-data"
             style="padding: 15px;"> '; ?>
                <label class="form-label" for="example-file-input">Ընտրեք նկարը համակարգչից, ավելացնելու համար</label>
      ...
      <label class="form-label" for="example-file-input" style="text-align: center;">Ուշադրություն։ Բոլոր ավելացրած նկարները հայտնվելու են կայքի "Մեր մասին" էջի "Նկարներ" հատվածում։</label>
