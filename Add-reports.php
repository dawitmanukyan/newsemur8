...
<html lang="en">
  <head>
    ...
    <title>Ավելացնել Հաշվետվություն</title>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <?php echo '<a class="nav-main-link active" href="Add-reports.php?h='.$_GET['h'].'">' ?>
      ...
      <main id="main-container">
       ...
       <?php echo '<form action="Add-reports-proccess.php?h='.$_GET['h'].'" method="post" style="padding: 15px;" enctype="multipart/form-data">'; ?>
            <div class="mb-4">
                <label class="form-label" for="example-text-input">Նշեք տարեթիվը</label>
                <input type="number" class="form-control" id="example-text-input" name="year" placeholder="Օրինակ 2023">
            </div>
            <div class="mb-4">
                <label class="form-label" for="example-file-input">Հաշվետվությունների ֆայլը (Ընտրեք ֆայլը համակարգչից, ավելացնելու համար)</label>
      ...
      <label class="form-label" for="example-file-input" style="text-align: center;">Ուշադրություն։ Բոլոր ավելացրած ֆայլերը հայտնվելու են կայքի "Հաշվետվություններ" էջում։</label>
