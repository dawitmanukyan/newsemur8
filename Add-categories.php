...
<html lang="en">
  <head>
    ...
    <title>Ավելացնել Կածեգորյա</title>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <?php echo '<a class="nav-main-link active" href="Add-categories.php?h='.$_GET['h'].'">' ?>
      ...
      <main id="main-container">
        ...
        <?php echo ' <form action="Add-categories-proccess.php?h='.$_GET['h'].'" method="post" enctype="multipart/form-data"
         style="padding: 15px;"> '; ?>
            <div class="mb-4">
                <label class="form-label" for="example-text-input">Կատեգորիաի անվանումը Հայերեն</label>
                <input type="text" class="form-control" id="example-text-input" name="cat-name-arm" placeholder="Օրինակ՝ Կղմինդր">
            </div>
            <div class="mb-4">
                <label class="form-label" for="example-text-input">Կատեգորիաի անվանումը Ռուսերեն</label>
                <input type="text" class="form-control" id="example-text-input" name="cat-name-ru" placeholder="Օրինակ՝ Плитка">
            </div>
            <div class="mb-4">
                <label class="form-label" for="example-text-input">Կատեգորիաի անվանումը Անգլերեն</label>
                <input type="text" class="form-control" id="example-text-input" name="cat-name-eng" placeholder="Օրինակ՝ Metal tile">
            </div>
            <div class="mb-4">
                <label class="form-label" for="example-file-input">Կատեգորիաի նկարը (Ընտրեք նկարը համակարգչից, ավելացնելու համար)</label>
