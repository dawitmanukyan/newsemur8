            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                  <?php echo' <a class="nav-main-link active" href="Add-blog.php?h='.$_GET['h'].'"> '; ?>
...
<!-- 
              ...
              <div class="options-container fx-item-zoom-in">
                ...
                <div class="options-overlay bg-black-75">
                  <div class="options-overlay-content">
                    <h3 class="h4 text-white mb-1">Ընտրել Նկարը</h3>
                    <a class="btn btn-sm btn-alt-secondary" href="javascript:void(0)">
                      <i class="fa fa-pencil-alt text-primary me-1"></i> Ընտրել
                    </a>
                  </div>
                </div>
              </div>
            ...
            <?php echo ' <form action="Add-blog-proccess.php?h='.$_GET['h'].'" method="post" enctype="multipart/form-data"
         style="padding: 15px;"> '; ?>

            <div class="mb-4">
                <label class="form-label" for="example-text-input">Բլոգի վերնագիրը Հայերեն</label>
                <input type="text" class="form-control" id="example-text-input" name="cat-name-arm" placeholder="Օրինակ՝ Նորություններ">
            </div>
            <div class="mb-4">
                <label class="form-label" for="example-text-input">Բլոգի վերնագիրը Ռուսերեն</label>
                <input type="text" class="form-control" id="example-text-input" name="cat-name-ru" placeholder="Օրինակ՝ Новости">
            </div>
            <div class="mb-4">
                <label class="form-label" for="example-text-input">Բլոգի վերնագիրը Անգլերեն</label>
                <input type="text" class="form-control" id="example-text-input" name="cat-name-eng" placeholder="Օրինակ՝ News">
            </div>
            <div class="mb-4">
                <label class="form-label" for="example-file-input">Բլոգի Հիմնական նկարը (Ընտրեք նկարը համակարգչից, ավելացնելու համար)</label>
            ...
            <div class="row mb-4">
                        ...
                        <div class="mb-4">
                        <label class="form-label" for="example-textarea-input">Գրեք Նկարագրությունը Հայերեն</label>
                        <textarea class="form-control" id="example-textarea-input" name="infoarm" rows="5" placeholder="Նկարագրություն․․․"></textarea>
                        </div><br>

                        <div class="mb-4">
                        <label class="form-label" for="example-textarea-input">Գրեք Նկարագրությունը Ռուսերեն</label>
                        <textarea class="form-control" id="example-textarea-input" name="inforu" rows="5" placeholder="Նկարագրություն․․․"></textarea>
                        </div><br>

                        <div class="mb-4">
                        <label class="form-label" for="example-textarea-input">Գրեք Նկարագրությունը Անգլերեն</label>
                        <textarea class="form-control" id="example-textarea-input" name="infoeng" rows="5" placeholder="Նկարագրություն․․․"></textarea>
                        </div><br>
