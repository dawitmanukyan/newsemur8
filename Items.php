...
<html lang="en">
  <head>
    ...
    <title>Կայքում առկա ապրանքներ</title>
          ...
          <div class="content-side">
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
                    <?php echo ' <a class="nav-main-link active" href="Items.php?h='.$_GET['h'].'"> '; ?>
      ...
      <main id="main-container">
        ...
        <div class="content content-boxed">
          ...
          <div class="row">
            <!-- Story -->
            <?php
              $imgs = $mysql -> query("SELECT * FROM `items`");

              foreach($imgs as $value){
                echo '<div class="col-lg-6"  style="text-align: center;">
                  <div class="block block-rounded block-link-pop overflow-hidden" href="/img-items/'.$value['ownimage'].'">
                    <img class="img-fluid" src="img-items/'.$value['ownimage'].'" alt="">
                    <br><br><h4>Հայերեն - '.$value['namearm'].'</h4>
                    <h4>Ռուսերեն - '.$value['nameru'].'</h4>
                    <h4>Անգլերեն - '.$value['nameeng'].'</h4><hr>
                    <h4>Նկարագրություն(Հայերեն) - '.$value['descriptionarm'].'</h4><hr>
                    <h4>Նկարագրություն(Ռուսերեն) - '.$value['descriptionru'].'</h4><hr>
                    <h4>Նկարագրություն(Անգլերեն) - '.$value['descriptioneng'].'</h4><hr>  
                    <h4>Հաստություն - '.$value['thickness'].'</h4><hr>  
                    <h4>Լայնություն - '.$value['width'].'</h4><hr>  
                    <h4>Օգտակար Լայնություն - '.$value['useful_width'].'</h4><hr>  
                    <h4>Երկարություն - '.$value['length'].'</h4><hr>  


                    <a href="Delete.php?h='.$_GET['h'].'&id='.$value['id'].'&type=items&file=Items.php"><button class="btn btn-danger" style="margin:5px;">Ջնջել</button></a>
                  </div>
                </div>';
              }
            ?>
