<?php
  ...
  $asr0 = $mysql -> query("SELECT * FROM `assortment` WHERE `incategory`=$cat");
  $mysql -> close();
?>
<!DOCTYPE html>
<html lang="hy">
    ...
    <section class="contect">
      <div class="container">
        ...
        <?php
              if($sts == 'off'){
                echo '
                <a href="./img/colors.png"><img src="./img/colors.png" class="colors-img resp"></a> 
                ';
              }else {
                echo '
                <a href="./img/colors.png"><img src="./img/colorson.png" class="colors-img resp"></a> 
                ';
              }
            ?>
