...
<html lang="en">
  <head>
    ...
    <title>Ավելացնել Տեղեկություններ</title>
    ...
    <div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed main-content-narrow">
            ...
            <ul class="nav-main">
              ...
              <li class="nav-main-item">
                ...
                <ul class="nav-main-submenu">
                  ...
                  <li class="nav-main-item">
                    <?php echo '<a class="nav-main-link active" href="Add-info.php?h='.$_GET['h'].'">' ?>
              ...
              <li class="nav-main-item">
                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                  ...
                  <span class="nav-main-link-name">Կածեգորյաներ</span>
                </a>
                <ul class="nav-main-submenu">
                  <li class="nav-main-item">
      ...
      <main id="main-container">
        ...
        <?php echo '<form action="Add-info-proccess.php?h='.$_GET['h'].'" method="post" style="padding: 15px;">' ?>
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկություններ Հայերեն</label>
                <textarea class="form-control" id="example-textarea-input" name="infoarm" rows="5" placeholder="Մեր մասին․․․"></textarea>
            </div><br>
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկություններ Ռուսերեն</label>
                <textarea class="form-control" id="example-textarea-input" name="inforu" rows="5" placeholder="Մեր մասին․․․"></textarea>
            </div><br>
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկություններ Անգլերեն</label>
        ...
        <?php echo '<form action="Add-header-info.php?h='.$_GET['h'].'" method="post" style="padding: 15px;">' ?>
        <label class="form-label" for="example-textarea-input">Գլխավոր էջի ինֆո</label>
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկության վերին հատվածը Հայերեն</label>
                <textarea class="form-control" id="example-textarea-input" name="hinfoarm1" rows="3" placeholder="Մեր մասին․․․"></textarea>
            </div><br>
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկություններ Հայերեն</label>
                <textarea class="form-control" id="example-textarea-input" name="hinfoarm2" rows="3" placeholder="Մեր մասին․․․"></textarea>
            </div><br>
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկության վերին հատվածը Ռուսերեն</label>
                <textarea class="form-control" id="example-textarea-input" name="hinforu1" rows="3" placeholder="Մեր մասին․․․"></textarea>
            </div><br>
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկություններ Ռուսերեն</label>
                <textarea class="form-control" id="example-textarea-input" name="hinforu2" rows="3" placeholder="Մեր մասին․․․"></textarea>
            </div><br>
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկության վերին հատվածը Անգլերեն</label>
                <textarea class="form-control" id="example-textarea-input" name="hinfoeng1" rows="3" placeholder="Մեր մասին․․․"></textarea>
            </div><br>  
            <div class="mb-4">
                <label class="form-label" for="example-textarea-input">Գրեք տեղեկություններ Անգլերեն</label>
                <textarea class="form-control" id="example-textarea-input" name="hinfoeng2" rows="3" placeholder="Մեր մասին․․․"></textarea>
            </div><br>  
      ...
      <label class="form-label" for="example-file-input" style="text-align: center;">Ուշադրություն։ Բոլոր ավելացրած տեղեկությունները հայտնվելու են կայքի "Մեր մասին" էջում։</label>
